...
class firebasestorage with ChangeNotifier {
  ...
  Future<void> getImage(String kayityeri) async {
    ...
    await FirebaseFirestore.instance
        .collection("users")
        .doc(auth.authid())
        .set({"${kayityeri}": downloadURL}, SetOptions(merge: true)).then(
            (value) => debugPrint("add users ${kayityeri} data"));
  }
  ...
  Future<void> galerikayit(var kayityeri) async {
    ...
    await FirebaseFirestore.instance
        ...
        .collection("galeri")
        .doc()
        .set(galeri, SetOptions(merge: true))
        .then((value) => debugPrint("add users data"));
  }
